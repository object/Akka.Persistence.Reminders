...
let product = "Akka.Persistence.Reminders"
...
Target "AssemblyInfo" (fun _ ->
    XmlPokeInnerText "./Akka.Persistence.Reminders/Akka.Persistence.Reminders.csproj" "//Project/PropertyGroup/VersionPrefix" releaseNotes.AssemblyVersion    
    XmlPokeInnerText "./Akka.Persistence.Reminders/Akka.Persistence.Reminders.csproj" "//Project/PropertyGroup/PackageReleaseNotes" (releaseNotes.Notes |> String.concat "\n")
)
...
Target "Protobuf" <| fun _ ->
    ...
    let protoFiles = [
        ("ReminderFormats.proto", "/Akka.Persistence.Reminders/Serialization/Proto/") ]
